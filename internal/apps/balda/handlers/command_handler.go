...
func (h *CommandHandler) onCommand(ctx context.Context, event *events.CommandEvent) error {
	...
	if h.commandIngress != nil && (req.Command == commandReset || req.Command == commandLocator || req.Command == commandHelp || req.Command == commandUsage || req.Command == commandAuto || req.Command == commandCancel || req.Command == commandGoal || req.Command == commandTopic || req.Command == commandClose || req.Command == commandUser || req.Command == commandPlugins) {
