...
- `/goal <objective>` (owner/collaborator): starts a Goalkeeper worker -> validator loop in the current session context/workspace and posts started/validation/final updates. See [`docs/goalkeeper.md`](goalkeeper.md).
